...
var _l_file = require('../lib/file');
var _l_sync = require('../lib/sync');
var _l_date = require('../lib/date');
...
request.prototype.display = function(file){
    ...
    try{
        ...
        this.res
            .setHeader('Content-Type',_l_mime[path.extname(file)] || "text/html");
...
//        string && string.length && this.res.setHeader('Content-Length',string.length);
        ...
        if(typeof(string)=='object'&&string.pipe){
...
request.prototype.sync = _l_sync;
request.prototype.date = _l_date;